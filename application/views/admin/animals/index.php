<h5 class="font-20 mt-15 mb-1"><?php echo str_replace('_',' ','Animals'); ?></h5>
<!--Action-->
<div>
	<div class="float_left padding_10">
		<a href="<?php echo site_url('admin/animals/save'); ?>"
			class="btn btn-success">Add</a>
	</div>
	<div class="float_left padding_10">
		<i class="fa fa-download"></i> Export <select name="xeport_type" class="select"
			onChange="window.location='<?php echo site_url('admin/animals/export'); ?>/'+this.value">
	...
	<div  class="float_right padding_10">
		<ul class="left-side-navbar d-flex align-items-center">
			<li class="hide-phone app-search mr-15">
                <?php echo form_open_multipart('admin/animals/search/',array("class"=>"form-horizontal")); ?>
...
<td><?php
									   ...
									   $dataArr = $this->CI->Types_model->get_types($c['types_id']);
									   echo $dataArr['name'];?>
									</td>
...
<td><?php echo $c['modified']; ?></td>
		...
		<td>
            <a href="<?php echo site_url('admin/animals/details/'.$c['id']); ?>"  class="action-icon"> <i class="zmdi zmdi-eye"></i></a>
            <a href="<?php echo site_url('admin/animals/save/'.$c['id']); ?>" class="action-icon"> <i class="zmdi zmdi-edit"></i></a>
            <a href="<?php echo site_url('admin/animals/remove/'.$c['id']); ?>" onClick="return confirm('Are you sure to delete this item?');" class="action-icon"> <i class="zmdi zmdi-delete"></i></a>
        </td>
    </tr>
	<?php } ?>
</table>
<!--End of Data display of animals//--> 
